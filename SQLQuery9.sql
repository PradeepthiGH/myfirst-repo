...
create nonclustered index Ecluster on employees ( 
employee_id asc,
first_name, 
last_name,email
)
...
select phone_number,first_name,salary from employees E inner join dependents D on E.employee_id = D.dependent_id
select *from employees
where department_id=9;
select * from employees
where department_id=10 And manager_id=100
